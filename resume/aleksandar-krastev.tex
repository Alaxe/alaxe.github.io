...
\begin{description}[labelwidth=3.75em]
    ...
    \item[\href{https://github.com/Alaxe/stealth}{Stealth}]
        2D game of sneaking past guards; computes visibility polygon in $O(n \log n)$
        (JavaScript)
\end{description}

\section*{Awards}
\begin{description}[labelwidth=6em]
    \item[Gold medal] (24th of 351) at the International Olympiad in
        Informatics,
        2018
    \item[Silver medal] (29th of 150) at the European Physics Olympiad, 2019
\end{description}
\end{document}
